...
- Recode_Var.R: A function I created to speed up the data cleaning/recoding process. The function can take an indefinte number of arguments and works on both vectors and dataframes.
